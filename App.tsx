...
import { calculateTip } from './src/logic';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View
            ...
            accessibilityLabel="Tip Percentage Selection"
          >
            {[10, 15, 18, 20].map((pct) => (
              <TouchableOpacity
                key={pct}
                style={[styles.pctBtn, tipPct === pct && styles.pctBtnActive]}
          ...
          <View
            style={styles.row}
            accessibilityLabel="Split People Adjuster"
          ...
          >
            ...
            <Text style={styles.peopleText} accessibilityLabel={`${people} People`}>
              {people}
            </Text>
            <TouchableOpacity
              style={styles.splitBtn}
          ...
          <TouchableOpacity
            ...
            accessibilityHint="Calculates the total bill and amount per person"
          >
        ...
        {result && (
          <View
            ...
            accessibilityLabel={`Total Bill: $${result.total}, Per Person: $${result.perPerson}`}
          >
